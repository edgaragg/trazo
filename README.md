...
Trazo is in alpha, so the interface can still change between minor versions. In CI, pin the version you tested with (`npx @edgaragg/trazo-cli@0.2.1 ...`) instead of following whatever is newest.
